            ...
            <header className="mx-auto py-4 px-6 md:px-24 flex justify-between items-center border-b border-gray-200 relative">
                ...
                <nav className="hidden md:flex justify-between items-center gap-8">
                    <ul className="nav-list flex items-center gap-8">
                        <li className="nav-item font-medium text-gray-500 hover:text-primary cursor-pointer">Features</li>
                        <li className="nav-item font-medium text-gray-500 hover:text-primary cursor-pointer">The Journey</li>
                        <li className="nav-item font-medium text-gray-500 hover:text-primary cursor-pointer">Pricing</li>
                ...
                {isOpen && (
                    <div className="absolute top-full left-0 right-0 bg-white border-b border-gray-200 p-6 md:hidden flex flex-col gap-6 shadow-lg animate-in fade-in slide-in-from-top-5 duration-200">
                        <ul className="flex flex-col gap-4">
                            <li className="font-medium text-lg text-gray-500 hover:text-primary cursor-pointer">Features</li>
                            <li className="font-medium text-lg text-gray-500 hover:text-primary cursor-pointer">The Journey</li>
                            <li className="font-medium text-lg text-gray-500 hover:text-primary cursor-pointer">Pricing</li>
                        </ul>
                        <div className="flex flex-col gap-3">
                            <button className="btn w-full py-2.5 text-gray-500 border border-gray-200 rounded-full hover:text-primary hover:border-primary transition-all"><Link to="/login">Login</Link></button>
                            <button className="btn w-full py-2.5 bg-primary text-white rounded-full font-bold hover:bg-primary/80 transition-all shadow-md"><Link to="/register">Sign Up</Link></button>
                        </div>
                    </div>
                )}
            </header>

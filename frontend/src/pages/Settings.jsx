                        ...
                        <div className="max-w-2xl flex flex-col gap-8">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="size-20 rounded-full bg-gradient-to-br from-primary to-orange-400 text-white flex items-center justify-center text-2xl font-bold shadow-lg shadow-orange-200">
                                        AM
                                    </div>
                                    <div className="flex gap-3">
                                        <button className="px-4 py-2 bg-gray-50 text-gray-700 font-bold text-sm rounded-xl hover:bg-gray-100 transition-colors">
                                            Change Photo
                                        </button>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <input type="text" defaultValue="Alex" className="p-3 bg-gray-50 border-none rounded-xl font-bold text-gray-900 focus:ring-2 focus:ring-primary/50 outline-none" />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-500 uppercase">Last Name</label>
                                        <input type="text" defaultValue="M." className="p-3 bg-gray-50 border-none rounded-xl font-bold text-gray-900 focus:ring-2 focus:ring-primary/50 outline-none" />
                                    </div>
                                    <div className="col-span-1 md:col-span-2 flex flex-col gap-2">
                                        <label className="text-xs font-bold text-gray-500 uppercase">Email Address</label>
                                        <input type="email" defaultValue="alex@example.com" className="p-3 bg-gray-50 border-none rounded-xl font-bold text-gray-900 focus:ring-2 focus:ring-primary/50 outline-none" />
                                    </div>
                                </div>
                            </div>
                        </div>

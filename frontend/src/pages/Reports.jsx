...
const Reports = () => {
    ...
    return (
        <div className="flex h-screen w-full bg-gray-50 overflow-hidden font-manrope">
            ...
            {/* Main Content */}
            <main className="flex-1 flex flex-col h-full overflow-y-auto relative scroll-smooth p-4 md:p-10">
                <DashboardHeader onMenuClick={() => setIsMobileMenuOpen(true)} title="" />
